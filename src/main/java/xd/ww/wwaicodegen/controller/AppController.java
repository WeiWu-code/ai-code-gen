package xd.ww.wwaicodegen.controller;
...
import xd.ww.wwaicodegen.common.ResultUtils;
...
public class AppController {
    ...
    public BaseResponse<Boolean> updateApp(@RequestBody AppUpdateRequest appUpdateRequest, HttpServletRequest request) {
        ...
        // 校验用户是否是本人
        userService.authUserAndGetId(oldApp.getUserId(), request);
        App app = new App();
        app.setId(id);
    ...
    public Flux<ServerSentEvent<String>> chatToGenCode(@RequestParam Long appId,
                                                       ...
                                                       @RequestParam(defaultValue = "true") boolean isGraph,
        ...
        // 获取当前登录用户
        User loginUser = userService.getLoginUser(request);
        Flux<String> contentFlux = appService.chatToGenCode(appId, message, loginUser, isGraph);
        return contentFlux
                .map(chunk -> {
